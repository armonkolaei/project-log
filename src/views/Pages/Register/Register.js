  ...
  render() {
    return (
      <div className="app flex-row align-items-center">
                  ...
                  <Form>
                    ...
                    <div className="input-group mb-4 tearms-service-register">
                      <input
                        type="checkbox"
                        id="terms"
                        onClick={this.setCheckboxStates.bind(this, "terms")}
                        value={this.state.terms}
                        onChange={this.updateTermsState}
                      />{" "}
                      I agree to the{" "}
        ...
        <Modal
          open={this.state.modalPrivacyIsOpen}
          onClose={this.PrivacycloseModal.bind(this)}
            ...
            <div className="container">
              <div className="row justify-content-center">
                <div className="tos-box-detail">
                  ...
                  <p>
                    MotherClock Inc. handles confidential financial information
                    from its customers, Canadian corporations, companies or
                    persons in the process of providing services. When you use
                    these services you trust us with your information. This
                    Privacy Policy is meant to help you understand what data we
                    collect, why we collect it, and what we do with it.{" "}
                  </p>
                  <p>
                    We collect information primarily to provide services to our
                    users. We also use this information internally to learn how
                    to provide, maintain and improve our services to our users,
                    and to protect MotherClock and our users. We will never use
                    your information for any other purpose without your express
                    written consent.{" "}
                  </p>
                  <p>
                    We collect information that you give to us and based on your
                  ...
                  <p>
                    Data security is our highest priority. We maintain a very
                    high level of protection against unauthorized intrusion.
                    Every member of our team pledges their commitment to keep
                    your data private and safe.{" "}
                  </p>
                  <p>
                    Our Privacy Policy applies to all of the services offered by
                    MotherClock Inc. The policy may change from time to time. We
                    will post any privacy policy changes on this page and, if
            ...
            <div className="container">
              <div className="row justify-content-center">
                <div className="tos-box-detail">
                  ...
                  <p>
                    Your use of MotherClock’s products, software, services and
                    web sites (referred to collectively as the “Services” in
                    this document and excluding any services provided to you by
                    MotherClock under a separate written agreement) is subject
                    to the terms of a legal agreement between you and
                    MotherClock. “MotherClock” means MotherClock Inc., whose
                    principal place of business is at 149 Burleigh Street,
                    Apsley, ON K0L 1A0, Canada.
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    option is made available to you by MotherClock in the user
                    interface for any Service; or
                  </p>
                  <p>
                    (B) using the Services. In this case, you understand and
                    agree that MotherClock will treat your use of the Services
                    as acceptance of the Terms from that point onwards.
                  </p>
                  <p>
                    You may not use the Services and may not accept the Terms if
                    (a) you are not of legal age to form a binding contract with
                    MotherClock, or (b) you are a person barred from receiving
                    the Services under the laws of Canada or other countries
                  ...
                  <p>
                    ...
                    provide information about yourself or your employees (such
                    as identification or contact details) as part of the
                    registration process for the Service, or as part of your
                    continued use of the Services. You agree that any
                    registration information you give to MotherClock will always
                    be accurate, correct and up to date.
                  </p>
                  <p>
                    While we will do everything possible to ensure that the
                    Services meets and exceeds your expectations, you expressly
                    understand and agree that:
                  </p>
                  <p>
                    (A) your use of the Services is at your sole risk and that
                    the Services are provided “as is” and “as available”; and
                  </p>
                  <p>
                    (B) MotherClock, its subsidiaries and affiliates, and its
                    licensors shall not be liable to you for any reason.
                  </p>
                  <p>
                    MotherClock may make changes to the Terms and Conditions or
                    Additional Terms from time to time. When these changes are
                    made, MotherClock will make a new copy of the Terms and
                    Conditions available at{" "}
                    <a href="#">
                      http://www.motherclock.com/termsofservice.html
                    </a>{" "}
                    and any new Additional Terms will be made available to you
                    from within, or through, the affected Services.
                  </p>
                  <p>
                    You understand and agree that if you use the Services after
                    the date on which the Terms and Conditions or Additional
                    Terms have changed, MotherClock will treat your use as
                    acceptance of the updated Terms and Conditions or Additional
                    Terms.
                  </p>
                </div>
              </div>
